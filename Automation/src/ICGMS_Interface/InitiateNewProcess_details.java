...
{	
	String EXCEL_PATH = "/Automation/src/ICGMS_Interface/Test Data/ICGMS Test Data.xlsx";
	String SHEETNAME = "SuperAdmin";
	String Oriental = "39";
	String Royal = "1";
	String United = "36";
	String Magma = "34";
	...
	String Cust_Email3 = "hascap814@tapi.re";
	String Cust_Email12 = "sumbadlet@eay.jp";
	String Cust_Email1 = "fatbeg106@cream.pink";
	String Cust_Email5 = "vandayrid@ruru.be";
	String Cust_Email4 = "md.jasim@sharajman.com";
...
//	public Random random = new Random();
	...
	private static String generateRandomCarRegistration() {		
